...
/**
 * Datagen for Mekanist
 */
public class DefaultMekanistCraftingProvider extends CustomRecipeProvider
{
    private static final String MEKANIST = ModJobs.MEKANIST_ID.getPath();

    public DefaultMekanistCraftingProvider(@NotNull final PackOutput packOutput)
    {
        super(packOutput);
    }
    ...
    {
        return "DefaultMekanistCraftingProvider";
    }

    @Override
    protected void registerRecipes(@NotNull final Consumer<FinishedRecipe> consumer)
    {
        CustomRecipeBuilder.create(MEKANIST, MODULE_CRAFTING, "gate_wood")
                .inputs(List.of(new ItemStorage(new ItemStack(Items.OAK_LOG, 5))))
                .result(new ItemStack(ModItems.woodgate))
                .showTooltip(true)
                .build(consumer);

        CustomRecipeBuilder.create(MEKANIST, MODULE_CRAFTING, "gate_iron")
                .inputs(List.of(new ItemStorage(new ItemStack(Items.IRON_NUGGET, 5))))
                .result(new ItemStack(ModItems.irongate))
                .showTooltip(true)
                .build(consumer);

        CustomRecipeBuilder.create(MEKANIST, MODULE_CRAFTING, "rails")
                .inputs(List.of(
                        new ItemStorage(new ItemStack(Items.STICK, 5)),
        ...
        CustomRecipeBuilder.create(MEKANIST, MODULE_CRAFTING, "lantern")
                .inputs(List.of(
                        new ItemStorage(new ItemStack(Items.IRON_NUGGET, 3)),
        ...
        CustomRecipeBuilder.create(MEKANIST, MODULE_CRAFTING, "soul_lantern")
                .inputs(List.of(
                        new ItemStorage(new ItemStack(Items.IRON_NUGGET, 3)),
                        new ItemStorage(new ItemStack(Items.GLASS_BOTTLE)),
    ...
    {
        CustomRecipeBuilder.create(
                        MEKANIST,
                        MODULE_CRAFTING,
                        "deoxidize_" + ForgeRegistries.ITEMS.getKey(input).getPath()
                )
