...
public class BuildingMekanistHut extends AbstractBuilding {
    ...
    /**
     * Keep this on the generic crafting module.
     * Using BuildingMechanic.CraftingModule adds mechanic-specific compatibility filters
     * and can prevent saving Mekanism infuser recipes (e.g. infused alloy).
     */
