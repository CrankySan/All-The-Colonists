...
public class MaleMekanistModel extends CitizenModel<AbstractEntityCitizen>
{

    public MaleMekanistModel(final ModelPart part)
    {
        super(part);
        hat.visible = false;
    }
    ...
    public static LayerDefinition createMesh()
    {
        ...
        // Restliches Modell unverändert (Arme, Beine, Körper, Bart etc.)
